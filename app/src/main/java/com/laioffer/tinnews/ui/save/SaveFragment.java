...
public class SaveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Bundle is used for comms between threads
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel
                .getAllSavedArticles()
                .observe(
                        getViewLifecycleOwner(), // LifecycleOwner obj gets notified when page closed, release resources
                        // otherwise there could be Memory Leak
                        savedArticles -> { // savedArticles is an observer
